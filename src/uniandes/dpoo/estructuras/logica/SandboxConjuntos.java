 ...
 * conjuntos implementados usando un árbol (TreeSet).
 *
 * Todos los métodos deben operar sobre el atributo arbolCadenas que se declara
 * como un NavigableSet.
 * 
 * El objetivo de usar el tipo NavigableSet es que sólo puedan usarse métodos de
 * esa interfaz y no métodos adicionales provistos por la implementación
 * concreta (TreeSet).
 * 
 * A diferencia de un Set, en un NavigableSet existe una noción de orden que en
 * este caso corresponde al órden lexicográfico.
 * 
 * No pueden agregarse nuevos atributos.
 */
public class SandboxConjuntos {
    /**
     * Un conjunto (set) de cadenas para realizar varias de las siguientes
     * operaciones.
     * 
    ...
    public List<String> getCadenasComoListaInvertida() {
        List<String> listaOrdenada = new ArrayList<>(arbolCadenas);
        Collections.sort(listaOrdenada, Comparator.reverseOrder());
        return listaOrdenada;
    }
    ...
    /**
     * Retorna una colección con las cadenas que hacen parte del conjunto de cadenas
     * y son mayores o iguales a la cadena que se recibe por parámetro
     * 
     * @param cadena
     * @return Una colección de cadenas mayores a la cadena dada. Si la cadena hace
     *         parte del conjunto, debe hacer parte de la colección retornada.
     */
     ...
     * 
     * Este método podría o no aumentar el tamaño del conjunto, dependiendo de si el
     * número está repetido o no.
     * 
    ...
    public void eliminarCadena(String cadena) {
        NavigableSet<String> copia = arbolCadenas;

        for (int i = 0; i < copia.size(); i++) {
            if (copia.contains(cadena)) {
    ...
    /**
     * Elimina una cadena del conjunto de cadenas, independientemente de las
     * mayúsculas o minúsculas
     * 
     * @param cadena La cadena que se va eliminar, sin tener en cuenta las
     *               mayúsculas o minúsculas
     */
    public void eliminarCadenaSinMayusculasOMinusculas(String cadena) {
        ...
        for (String actual : arbolCadenas) {
            if (actual.toLowerCase().equals(cadenaMinus)) {
                eliminar = actual;
                break;
            }
        }
    ...
    /**
     * Reinicia el conjunto de cadenas con las representaciones como Strings de los
    ...
    /**
     * Modifica el conjunto de cadenas para que todas las cadenas estén en
     * mayúsculas.
     * 
     * Note que esta operación podría modificar el órden de los elementos dentro del
     * conjunto.
     */
    public void volverMayusculas() {
        ...
        for (String actual : copia) {
            temp = actual.toUpperCase();
            nuevo.add(temp);
        }
    ...
    /**
     * Construye un árbol de cadenas donde todas las cadenas están organizadas de
     * MAYOR a MENOR.
     */
    public TreeSet<String> invertirCadenas() {
        NavigableSet<String> copia = arbolCadenas;
        TreeSet<String> nuevo = new TreeSet<>(copia.descendingSet());
